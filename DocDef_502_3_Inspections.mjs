...
let def_Sec_3_1_1 = new DocSection().i(true, "3.1.1", true, "Propeller", true, `html/Inspection/502/Insp_PROPELLER_502.html`);
let def_Sec_3_1_2 = new DocSection().i(true, "3.1.2", true, "Engine and Mount", true, `html/Inspection/502/Insp_ENGINE AND MOUNT_502.html`);
let def_Sec_3_1_3 = new DocSection().i(true, "3.1.3", true, "Electrical System", true, `html/Inspection/502/Insp_ELECTRICAL SYSTEM_502.html`);
let def_Sec_3_1_4 = new DocSection().i(true, "3.1.4", true, "Fuel System", true, `html/Inspection/502/Insp_FUEL SYSTEM_502.html`);
let def_Sec_3_1_5 = new DocSection().i(true, "3.1.5", true, "Oil System", true, `html/Inspection/502/Insp_OIL SYSTEM_502.html`);
let def_Sec_3_1_6 = new DocSection().i(true, "3.1.6", true, "Power and Propeller Speed Coordinating System", true, `html/Inspection/502/Insp_POWER AND PROPELLER SPEED COORDINATING SYSTEM_502.html`);
let def_Sec_3_1_7 = new DocSection().i(true, "3.1.7", true, "Induction System", true, `html/Inspection/502/Insp_INDUCTION SYSTEM_502.html`);
let def_Sec_3_1_8 = new DocSection().i(true, "3.1.8", true, "Main Landing Gear and Brakes", true, `html/Inspection/502/Insp_MAIN LANDING GEAR AND BRAKES_502.html`);
let def_Sec_3_1_9 = new DocSection().i(true, "3.1.9", true, "Tail Gear", true, `html/Inspection/502/Insp_TAIL GEAR_502.html`);
let def_Sec_3_1_10 = new DocSection().i(true, "3.1.10", true, "Fuselage Frame", true, `html/Inspection/502/Insp_FUSELAGE FRAME_502.html`);
let def_Sec_3_1_11 = new DocSection().i(true, "3.1.11", true, "Fuselage Fixed Skins", true, `html/Inspection/502/Insp_FUSELAGE FIXED SKINS_502.html`);
let def_Sec_3_1_12 = new DocSection().i(true, "3.1.12", true, "Control System", true, `html/Inspection/502/Insp_CONTROL SYSTEM_502.html`);
let def_Sec_3_1_13 = new DocSection().i(true, "3.1.13", true, "Wings", true, `html/Inspection/502/Insp_WINGS_502.html`);
let def_Sec_3_1_14 = new DocSection().i(true, "3.1.14", true, "Ailerons", true, `html/Inspection/502/Insp_AILERONS_502.html`);
let def_Sec_3_1_15 = new DocSection().i(true, "3.1.15", true, "Flaps", true, `html/Inspection/502/Insp_FLAPS_502.html`);
let def_Sec_3_1_16 = new DocSection().i(true, "3.1.16", true, "Empennage", true, `html/Inspection/502/Insp_EMPENNAGE_502.html`);
...
let def_Sec_3_2_5 = new DocSection().i(true, "3.2.5", true, "Propeller Strike / Sudden Stoppage", true, "html/Inspection/502/Insp_Propeller Strike or Sudden Stoppage_502.html");
