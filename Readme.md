...
1. Click the Live Server button on the "My Tree View" title bar (or run **OM: Open Manual in Live Server...**), pick the model (402/502/602/802), and pick Chrome as the browser. This serves and opens the actual `index<model>.html` / `web802.html` through Paged.js — the fully paginated render with resolved xrefs and real figure numbers.
