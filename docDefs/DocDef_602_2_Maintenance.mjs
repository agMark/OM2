...
let defSec_2_30_9 = new DocSection().i(true, "2.30.9", true, "Rudder Trim Rigging", true, "html/Maintenance/602/Rudder Trim Rigging_602.html");
let defSec_2_30_20 = new DocSection().i(true, "2.30.20", true, "Reserved", false, "");
...
let defSec_2_35_2 = new DocSection().i(true, "2.35.2", true, "Hopper Gate Box", true, "html/Maintenance/602/Hopper Gate Box and Adapter_602.html");
...
let defSec_2_50_23 = new DocSection().i(true, "2.50.23", true, "Reserved", false, ""); // Was "P3 Air Pressure Tube_602.html"
...
let defSec_2_75_21 = new DocSection().i(true, "2.75.21", true, "Fuel Tank Quantity System Senders - CiES", true, "html/Maintenance/602/CiES Fuel Tank Senders_602.html");
