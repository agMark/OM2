...
let defSec_2_35_2 = new DocSection().i(true, "2.35.2", true, "Hopper Gate Box", true, "html/Maintenance/Hopper Gate Box and Adapter.html");
...
let defSec_2_40_10a = new DocSection().i(false,"2.40.10a", true, "Rear Cockpit Lighting", true, "html/Maintenance/Cockpit Lighting Rear Seat.html");
let defSec_2_40_10 = new DocSection().i(true, "2.40.10", true, "Cockpit Lighting", true, "html/Maintenance/Cockpit Lighting.html");
defSec_2_40_10.s([defSec_2_40_10a]);
...
let defSec_2_75_21 = new DocSection().i(true, "2.75.21", true, "Fuel Tank Quantity System Senders - CiES", true, "html/Maintenance/CiES Fuel Tank Senders_802.html");
