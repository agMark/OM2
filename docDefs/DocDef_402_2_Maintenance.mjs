...
let defSec_2_30_8 = new DocSection().i(true, "2.30.8", true, "Reserved", false, "");
...
let defSec_2_50_23 = new DocSection().i(true, "2.50.23", true, "Reserved", false, ""); // Was "P3 Air Pressure Tube_402.html"
...
let defSec_2_55_6 = new DocSection().i(true, "2.55.6", true, "Reserved", false, "");
...
let defSec_2_75_21 = new DocSection().i(true, "2.75.21", true, "Fuel Tank Quantity System Senders - CiES", true, "html/Maintenance/402/CiES Fuel Tank Senders_402.html");
